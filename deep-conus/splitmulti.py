...
parser.add_argument('--filestr',    type=str,   default='spatial_storm_data_part',  help='set filename substring (expects $(filestr)X.nc, X = 1..n)')
...
# Run function
split_data_val_multi(datasrc=args.datasrc, filestr=args.filestr, outdir=args.outdir, 
