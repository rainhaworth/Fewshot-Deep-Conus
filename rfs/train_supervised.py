...
def parse_option():
    ...
    elif opt.dataset != 'miniDeepConus': # Disable this for my model
...
def main():
    ...
    if opt.dataset == 'miniImageNet':
        ...
        # Notes/troubleshooting:
            ...
            # Also, validate() from eval/cls_eval.py might be causing issues
        train_trans, test_trans = transforms_options[opt.transform]
        train_loader = DataLoader(DeepConus(args=opt, partition=train_partition, transform=train_trans),
                                  batch_size=opt.batch_size, shuffle=True, drop_last=True,
                                  num_workers=opt.num_workers)
